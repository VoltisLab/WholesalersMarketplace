...
class EnhancedProductProvider extends ChangeNotifier {
  ...
  Map<String, dynamic> _getVendorData(int index) {
    final vendorData = [
      ...
      {'name': 'Book Nook', 'category': 'Books', 'city': 'Finland', 'rating': 4.4, 'reviews': 456},
      {'name': 'Beauty Bar', 'category': 'Beauty', 'city': 'Sweden', 'rating': 4.9, 'reviews': 987},
      {'name': 'Car Care', 'category': 'Automotive', 'city': 'Norway', 'rating': 4.3, 'reviews': 321},
      {'name': 'Pet Care Plus', 'category': 'Pets', 'city': 'Denmark', 'rating': 4.7, 'reviews': 654},
      {'name': 'Sound Studio', 'category': 'Music', 'city': 'Iceland', 'rating': 4.5, 'reviews': 432},
      {'name': 'Gourmet Kitchen', 'category': 'Kitchen', 'city': 'Ireland', 'rating': 4.8, 'reviews': 789},
      {'name': 'Fun Zone', 'category': 'Toys', 'city': 'Malta', 'rating': 4.6, 'reviews': 876},
      {'name': 'Business Solutions', 'category': 'Office', 'city': 'Cyprus', 'rating': 4.2, 'reviews': 543},
      {'name': 'Diamond District', 'category': 'Jewelry', 'city': 'Luxembourg', 'rating': 4.9, 'reviews': 765},
      {'name': 'Creative Crafts', 'category': 'Crafts', 'city': 'Monaco', 'rating': 4.4, 'reviews': 321},
      {'name': 'Wellness Center', 'category': 'Health', 'city': 'Andorra', 'rating': 4.7, 'reviews': 654},
      {'name': 'Little Angels', 'category': 'Baby', 'city': 'San Marino', 'rating': 4.8, 'reviews': 432},
      {'name': 'Adventure Gear', 'category': 'Outdoor', 'city': 'Liechtenstein', 'rating': 4.5, 'reviews': 789},
      {'name': 'Game Central', 'category': 'Gaming', 'city': 'Vatican City', 'rating': 4.6, 'reviews': 876},
      {'name': 'Artist Studio', 'category': 'Art', 'city': 'Bangladesh', 'rating': 4.3, 'reviews': 543},
      {'name': 'Journey Essentials', 'category': 'Travel', 'city': 'Sri Lanka', 'rating': 4.7, 'reviews': 765},
      {'name': 'Retro Revival', 'category': 'Vintage', 'city': 'Nepal', 'rating': 4.4, 'reviews': 321},
      {'name': 'Smart Solutions', 'category': 'Electronics', 'city': 'Bhutan', 'rating': 4.8, 'reviews': 987},
      {'name': 'Style Studio', 'category': 'Fashion', 'city': 'Maldives', 'rating': 4.9, 'reviews': 654},
      {'name': 'Garden Oasis', 'category': 'Garden', 'city': 'Afghanistan', 'rating': 4.5, 'reviews': 432},
      {'name': 'Power Gym', 'category': 'Fitness', 'city': 'Iran', 'rating': 4.6, 'reviews': 789},
      {'name': 'Literary Lounge', 'category': 'Books', 'city': 'Iraq', 'rating': 4.4, 'reviews': 876},
      {'name': 'Glamour Gallery', 'category': 'Beauty', 'city': 'Jordan', 'rating': 4.9, 'reviews': 543},
